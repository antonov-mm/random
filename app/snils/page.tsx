  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">СНИЛС (страховой номер индивидуального лицевого счёта) — уникальный номер индивидуального лицевого счёта застрахованного лица в системе обязательного пенсионного страхования РФ. 
          На данной странице Вы можете сформировать один или несколько случайных валидных СНИЛС. Полученные данные можно использовать, например, для заполнения тестовой БД.</p>
      </div>
